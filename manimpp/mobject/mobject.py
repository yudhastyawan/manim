...
from manimpp.utils.color import interpolate_color
from manimpp.utils.iterables import list_update
from manimpp.utils.iterables import remove_list_redundancies
from manimpp.utils.paths import straight_path
from manimpp.utils.simple_functions import get_parameters
...
class Mobject(Container):
    ...
    def add_background_rectangle(self, color=BLACK, opacity=0.75, **kwargs):
        ...
        from manimpp.mobject.shape_matchers import BackgroundRectangle
