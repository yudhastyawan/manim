...
def get_module(file_name):
    if file_name == "-":
        ...
        code = "from manimpp.imports import *\n\n" + sys.stdin.read()
        try:
...
def get_camera_configuration(args):
    camera_config = {}
    if args.low_quality:
        camera_config.update(manimpp.constants.LOW_QUALITY_CAMERA_CONFIG)
    elif args.medium_quality:
        camera_config.update(manimpp.constants.MEDIUM_QUALITY_CAMERA_CONFIG)
    elif args.high_quality:
        camera_config.update(manimpp.constants.HIGH_QUALITY_CAMERA_CONFIG)
    else:
        camera_config.update(manimpp.constants.PRODUCTION_QUALITY_CAMERA_CONFIG)
